...
drasi apply -f examples/building_comfort/drasi_platform/query_container_default/query_default_server_core.yaml
drasi wait -f examples/building_comfort/drasi_platform/query_container_default/query_default_server_core.yaml -t 200
