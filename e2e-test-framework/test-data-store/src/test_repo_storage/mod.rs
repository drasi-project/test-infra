...
const TEST_SOURCE_BOOTSTRAP_SCRIPTS_FOLDER_NAME: &str = "bootstrap_scripts";
const TEST_SOURCE_CHANGE_SCRIPTS_FOLDER_NAME: &str = "change_scripts";
...
impl TestStorage {
    ...
    pub async fn get_test_source(&self, id: &str, replace: bool) -> anyhow::Result<TestSourceStorage> {
        ...
        let change_scripts_path = source_path.join(TEST_SOURCE_CHANGE_SCRIPTS_FOLDER_NAME);
        ...
        if !source_path.exists() {
            ...
            .get_test_source_content_from_def(
                ...
                id.to_string(), 
                bootstrap_scripts_path.clone(),
                change_scripts_path.clone()
            ).await?;
        }
