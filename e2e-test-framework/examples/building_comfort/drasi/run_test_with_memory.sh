...
drasi apply -f examples/building_comfort/drasi/query_container_memory.yaml
drasi wait -f examples/building_comfort/drasi/query_container_memory.yaml -t 200
